...
using Color_ColorSpace = TinyImage.Codecs.Jpeg2000.Color.ColorSpace;
using ColorSpaceException = TinyImage.Codecs.Jpeg2000.Color.ColorSpaceException;

namespace TinyImage.Codecs.Jpeg2000.Icc
{
