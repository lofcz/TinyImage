...
namespace TinyImage.Codecs.Jpeg2000.j2k.wavelet.synthesis
{
    ...
    internal class InvWTFull : InverseWT
    {
        ...
        public override void setTile(int x, int y)
        {
            ...
            for (i = 0; i < nc; i++)
            {
                ...
                // Mark the reconstructed component as needing reconstruction for the new tile.
                // The rented buffers are kept and will be reused, but the wavelet data must be
                // reconstructed since we've switched to a different tile.
