...
namespace TinyImage.Codecs.Jpeg2000.j2k.entropy.decoder
{
    ...
    internal class StdEntropyDecoder : EntropyDecoder
    {
        ...
        ~StdEntropyDecoder()
        {
            ...
            FacilityManager.getMsgLogger().printmsg(TinyImage.Codecs.Jpeg2000.j2k.util.MsgLogger_Fields.INFO, sb.ToString());
