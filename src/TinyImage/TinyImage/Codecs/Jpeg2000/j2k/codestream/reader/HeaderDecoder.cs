...
* */
using TinyImage.Codecs.Jpeg2000.Color;
using TinyImage.Codecs.Jpeg2000.Icc;
using TinyImage.Codecs.Jpeg2000.j2k.decoder;
using TinyImage.Codecs.Jpeg2000.j2k.entropy;
using TinyImage.Codecs.Jpeg2000.j2k.entropy.decoder;
using TinyImage.Codecs.Jpeg2000.j2k.image;
using TinyImage.Codecs.Jpeg2000.j2k.io;
using TinyImage.Codecs.Jpeg2000.j2k.quantization.dequantizer;
using TinyImage.Codecs.Jpeg2000.j2k.roi;
using TinyImage.Codecs.Jpeg2000.j2k.util;
using TinyImage.Codecs.Jpeg2000.j2k.wavelet;
using TinyImage.Codecs.Jpeg2000.j2k.wavelet.synthesis;
using System;
...
namespace TinyImage.Codecs.Jpeg2000.j2k.codestream.reader
{
    ...
    internal class HeaderDecoder
    {
        ...
        public virtual void readFoundTilePartMarkSeg(int tileIdx, int tpIdx)
        {
            ...
            //UPGRADE_TODO: Class 'java.io.DataInputStream' was converted to 'System.IO.BinaryReader' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javaioDataInputStream'"
            //TinyImage.Codecs.Jpeg2000.EndianBinaryReader dis;
            System.IO.MemoryStream bais;
