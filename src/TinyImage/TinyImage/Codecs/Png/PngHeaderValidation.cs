...
internal readonly struct PngHeaderValidation
{
    ...
    public PngHeaderValidation(int byte1, int byte2, int byte3, int byte4, int byte5, int byte6, int byte7, int byte8)
    {
        Byte1 = byte1;
        Byte2 = byte2;
        Byte3 = byte3;
