...
namespace TinyImage.Codecs.Jpeg2000.j2k.codestream.reader
{
    ...
    internal class PktDecoder
    {
        ...
        public virtual bool readSOPMarker(int[] nBytes, int p, int c, int r)
        {
            ...
            // Cast to short to handle signed comparison correctly (Markers.SOP is a negative short)
        ...
        public virtual void readEPHMarker(PktHeaderBitReader bin)
        {
            ...
            // Check if this is the correct marker
            // Cast to short to handle signed comparison correctly (Markers.EPH is a negative short)
