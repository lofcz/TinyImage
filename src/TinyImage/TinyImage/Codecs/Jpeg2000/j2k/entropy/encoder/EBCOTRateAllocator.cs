...
using TinyImage.Codecs.Jpeg2000.j2k.codestream.writer;
...
namespace TinyImage.Codecs.Jpeg2000.j2k.entropy.encoder
{
    ...
    internal sealed class EBCOTRateAllocator : PostCompRateAllocator
    {
